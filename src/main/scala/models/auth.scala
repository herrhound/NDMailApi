...
case class User(userid: UUID, username: String, userpassword: String, email: Option[String], secretquestion: Option[String], secretanswer: Option[String]/*, applicationId: UUID*/) // transactionid: Option[Int], systemstatusid: Int)
